...
\citeA{Kuang_JAS_2010} \todo{hereafter K10} suggested that although there are many non-linear
...
a CRM reference. \citeA{Hwong_JAMES_2021} \todo{hereafter H21} \todo{SS: I think we need a bit more discussion of how these results relate to the conclusions of that study} used the framework to evaluate
...
than the value of 1 kg m$^{-3}$ assumed by \citeA{Chua_GRL_2019}.
...
The study builds on \citeA{Kuang_JAS_2010}, here \todo{K10}, who first calculated such responses, and other studies (in particular \citeA{Hwong_JAMES_2021}, \todo{H21}) who used them to test convective schemes used in global models.
...
than in \citeA{Kuang_JAS_2010}, while in the boundary layer we find gradients in response within the lowest kilometer of the atmosphere that were not shown in the early study. The question is, then, what resolution is
